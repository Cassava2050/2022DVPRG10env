...
trial_tidy_all %>% distinct(trial_name)
```
...
stab_values <- master_data[c(20:30)] %>% 
...
meta_file_name <- paste0(folder_output, paste0("2022", trial_interest, "3env", "_master_results_", Sys.Date(), "_.xlsx" ))
...
```{r}
write.csv(selections, here::here("output", paste("01", year_interest, trial_interest, "3env",
