...
my_dat <- my_dat[!my_dat$trial_name %in% c("202136DVPRG_ciat", "202050DVPRG_ciat"), ]
...
PALMIRA <- trial_rm_sd %>% filter(trial_name %in% c("202050DVPRG_ciat", "202136DVPRG_ciat")) %>% 
...
names(master_data)[29] <- "BLUP_BLUE_root_commercial"
names(master_data)[44] <- "stability_germ_number_plot"
names(master_data)[54] <- "stability_root_commercial"
